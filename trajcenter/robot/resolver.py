...
archive into a fully resolved :class:`trajcenter.robot.models.ResolvedTrajectory`
payload.

The resolver is intentionally independent from RWS HTTP calls. It receives the
robot-side context already read by ``trajcenter.robot.reader`` and produces typed

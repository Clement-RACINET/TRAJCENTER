...
:class:`trajcenter.robot.errors.base.TrajCenterError`.

This module contains no HTTP or RWS translation logic -- see
:mod:`trajcenter.robot.errors.translate` for that.
"""

from __future__ import annotations

from trajcenter.robot.errors.base import (
    TrajCenterAuthError,
...
class InternalClientError(TrajCenterInternalError):
    ...
    ABB Constraints:
        ...
        :func:`trajcenter.robot.errors.translate.from_rws_exception`.
...
class ControllerTimeout(TrajCenterUpstreamError):
    ...
    ABB Constraints:
        Distinct from :class:`trajcenter.robot.errors.codes.RWSRequestTimeout`

...
"""Unit tests for :mod:`trajcenter.convert.csv_converter`.

> **Author**: Clément RACINET

Covers:

- :func:`~trajcenter.convert.csv_converter._detect_separator`
- :class:`~trajcenter.convert.csv_converter.CsvConverter`
...
from trajcenter.convert.csv_converter import CsvConverter, _detect_separator

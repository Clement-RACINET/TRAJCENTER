...
"""Unit tests for :mod:`trajcenter.robot.writer`.
...
_MODULE = "trajcenter.robot.writer"
...
class TestEaxPresence:
    """Tests for :func:`trajcenter.robot.writer._eax_presence`."""
...
class TestRowToRobtarget:
    """Tests for :func:`trajcenter.robot.writer._row_to_robtarget`."""
...
class TestWriteStoreMetadata:
    """Tests for :func:`trajcenter.robot.writer.write_store_metadata`."""
...
class TestWriteResolvedTrajectory:
    """Tests for :func:`trajcenter.robot.writer.write_resolved_trajectory`."""
...
class TestRetryMastership:
    """Tests for :func:`trajcenter.robot.writer._retry_mastership`."""

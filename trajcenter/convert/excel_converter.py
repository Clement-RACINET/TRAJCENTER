#!/usr/bin/env python3
# trajcenter/convert/excel_converter.py
"""Converter for Excel files (``.xlsx``, ``.xls``) to ``.trajcenter``.

> **Author**: Clément RACINET

Delegates all conversion logic to
:class:`~trajcenter.convert.tabular_converter._TabularConverter`.
...
when explicit :class:`~trajcenter.convert.defaults.ConversionDefaults`
values are provided.
...
class ExcelConverter(_TabularConverter):
    ...
    :class:`~trajcenter.convert.tabular_converter._TabularConverter` and
